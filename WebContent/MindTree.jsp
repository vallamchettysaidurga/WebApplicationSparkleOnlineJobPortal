...
<sql:query dataSource="${snapshot}" var="result">  
	  Select jobId,jobRole,categeory,jobType,jobLocation from jobDetails where jobId = 205
</sql:query>    
...
<center><a href="job3.jsp" class="next">&laquo;View and Apply</a></center><br><br>
<footer class="footer">
