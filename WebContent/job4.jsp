...
<title>Hexaware Description</title>
</head>
<body>
<header class="topnav">
...
<marquee>Find the right job on Sparkle.com. You are only few steps away from millions of jobs</marquee>
 ...
 <a href="Hexaware.jsp" class="previous">&laquo;Back</a>
...
<sql:query dataSource="${snapshot}" var="result">  
	  Select description from jobDetails where jobId = 505
</sql:query>    
...
<center><a href="job4.jsp" class="next">&laquo;Apply</a></center><br><br>
<footer class="footer">
