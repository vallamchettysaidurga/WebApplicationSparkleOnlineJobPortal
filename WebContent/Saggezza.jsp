...
<title>Saggezza India Pvt Ltd</title>
</head>
<body>
<header class="topnav">
...
<sql:query dataSource="${snapshot}" var="result">  
	  Select jobId,jobRole,categeory,jobType,jobLocation from jobDetails where jobId = 483
</sql:query>    
...
<center><a href="job5.jsp" class="next">&laquo;View and Apply</a></center><br><br>
<footer class="footer">
