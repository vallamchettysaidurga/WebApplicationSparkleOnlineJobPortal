...
<title>TechMahindra Details</title>
</head>
<body>
<header class="topnav">
...
<a href="TechMahindra.jsp" class="previous">&laquo; Back</a>
 <a href="HomePage.jsp" class="previous">&laquo; Home</a>
 <left><a href="jobsPage.jsp" class="logout">&laquo;Logout</a></left>
<br><br>
...
<sql:query dataSource="${snapshot}" var="result">  
	  Select description from jobDetails where jobId = 100
</sql:query>    
...
<center><a href="job1.jsp" class="next" >&laquo;Apply</a></center><br><br>
<footer class="footer">
