...
<title>MindTree Description</title>
</head>
<body>
<header class="topnav">
...
<marquee>Find the right job on Sparkle.com. You are only few steps away from millions of jobs</marquee>
 ...
 <a href="MindTree.jsp" class="previous">&laquo;Back</a>
...
<sql:query dataSource="${snapshot}" var="result">  
	  Select description from jobDetails where jobId = 205
</sql:query>    
...
<center><a href="job3.jsp" class="next">&laquo;Apply</a></center><br><br>
<footer class="footer">
