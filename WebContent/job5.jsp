...
<title>Saggezza Description</title>
</head>
<body>
<header class="topnav">
...
<marquee>Find the right job on Sparkle.com. You are only few steps away from millions of jobs</marquee>
 ...
 <a href="Saggezza.jsp" class="previous">&laquo;Back</a>
...
<sql:query dataSource="${snapshot}" var="result">  
	  Select description from jobDetails where jobId = 483
</sql:query>    
...
<center><a href="job5.jsp" class="next">&laquo;Apply</a></center><br><br>
<footer class="footer">
