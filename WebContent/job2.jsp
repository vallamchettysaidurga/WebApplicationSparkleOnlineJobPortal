...
<title>Accenture Description</title>
</head>
<body>
<header class="topnav">
...
<a href="Accenture.jsp" class="previous">&laquo; Back</a>
...
<sql:query dataSource="${snapshot}" var="result">  
	  Select description from jobDetails where jobId = 101
</sql:query>    
...
<center><a href="job2.jsp" class="next">&laquo;Apply</a></center><br><br>
<footer class="footer">
