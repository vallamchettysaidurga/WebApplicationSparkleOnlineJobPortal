...
<sql:query dataSource="${snapshot}" var="result">  
	  Select jobId,jobRole,categeory,jobType,jobLocation from jobDetails where jobId = 100
</sql:query>    
...
<center><a href="job1.jsp" class="next">&laquo;View and Apply</a></center><br><br>
<footer class="footer">
